...
The `demo_macro::generate_component_pages!()` macro generates route components, but you must manually import them. Add the route to the imports at the top of `app.rs` (around line 9-11):
...
- Clean and rebuild the macro: `rm -rf target/debug/deps/*demo_macro* && cargo build`
