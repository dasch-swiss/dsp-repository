...
- [ ] A change to a landing page or to `shared-fair` was measured, not assumed: `just fair-check http://host.docker.internal:4000/dpe/projects/0862 12` against a local `just dev`, and the score recorded as a row in `docs/src/dpe/machine-readable-metadata.md`. A test says the metadata is *there*; only this says it is *readable* (`docs/adr/0005-fair-landing-pages-in-the-access-area.md`)
