//! Two audiences share this module, per `areas/deposit/editor/CLAUDE.md`'s "machine-facing routes
//! live under /api/v1/" rule: [`list`] and [`report`] below are `/api/v1` — JSON or a bare status,
