...
pub struct EditorConfig {
    ...
    /// `areas/deposit/editor/public`, resolved relative to the working directory,
...
impl Default for EditorConfig {
    fn default() -> Self {
        Self {
            ...
            public_dir: PathBuf::from("areas/deposit/editor/public"),
            data_dir: None,
            env: "DEV".to_string(),
            db_dir: None,
            db_readers: 4,
...
mod tests {
    ...
    fn defaults_are_sensible() {
        ...
        assert_eq!(config.public_dir, PathBuf::from("areas/deposit/editor/public"));
...
mod reveal_tests {
    ...
    fn test_the_published_image_is_excluded_by_its_own_default() {
        // `areas/deposit/editor/Dockerfile` sets EDITOR_ENV=PROD and leaves
