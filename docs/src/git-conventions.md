...
- **Crate scopes:** `dpe-core`, `dpe-server`, `dpe-web`, `dpe-api-oai`, `shared-fair`, `shared-metadata`, `shared-telemetry`, `editor-core`, `editor-web`, `editor-server`, `mosaic-tiles`, `mosaic-playground`
