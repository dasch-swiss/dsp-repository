...
└── deposit/                   # Deposit Area
    ├── docs/adr/              # The area's decision records, cited areas/deposit/ADR-NNNN (ADR-0006)
