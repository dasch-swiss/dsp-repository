...
impl Renderer for TsvRenderer {
    ...
    fn resource_type_describe(
        ...
        // TSV format: header row + one row per field. Mirrors CSV shape with tab separator.
        ...
        // the 7-column set without `iri`, byte-identical to the pre-020 tsv output.
...
mod tests {
    ...
    #[test]
    fn projects_tsv_stderr_disclosure() {
        let out = SharedBuf::new();
        let err = SharedBuf::new();
        let mut renderer = TsvRenderer::with_writers(out.clone(), err.clone());
        let view = ProjectListView { items: make_fixture(), total: 3, filter: None };
    ...
    #[test]
    fn auth_status_tsv_stderr_disclosure() {
        ...
        let mut renderer2 = TsvRenderer::with_writers(out2.clone(), err2.clone());
    ...
    #[test]
    fn project_describe_tsv_output() {
        let out = SharedBuf::new();
        let err = SharedBuf::new();
        let mut renderer = TsvRenderer::with_writers(out.clone(), err.clone());
    ...
    #[test]
    fn project_describe_tsv_no_longname() {
        let out = SharedBuf::new();
        let mut renderer = TsvRenderer::with_writer(out.clone());
        let detail = ProjectDetail {
    ...
    #[test]
    fn project_describe_tsv_stderr_disclosure() {
        let out = SharedBuf::new();
        let err = SharedBuf::new();
        let mut renderer = TsvRenderer::with_writers(out.clone(), err.clone());
        let detail = ProjectDetail {
    ...
    #[test]
    fn data_models_tsv_stderr_disclosure() {
        let out = SharedBuf::new();
        let err = SharedBuf::new();
        let mut renderer = TsvRenderer::with_writers(out.clone(), err.clone());
        let view = DataModelListView { items: make_data_model_fixture(), total: 3, filter: None };
    ...
    #[test]
    fn data_model_describe_tsv_output() {
        let out = SharedBuf::new();
        let err = SharedBuf::new();
        let mut renderer = TsvRenderer::with_writers(out.clone(), err.clone());
        let meta = make_meta("anonymous", "https://api.test.dasch.swiss");
    ...
    #[test]
    fn data_model_describe_tsv_no_label_no_last_modified() {
        let out = SharedBuf::new();
        let mut renderer = TsvRenderer::with_writer(out.clone());
        ...
        let stdout = out.string();
        // None label → empty, None last_modified → empty (two consecutive tabs)
        assert!(
    ...
    #[test]
    fn data_model_describe_tsv_stderr_disclosure() {
        let out = SharedBuf::new();
        let err = SharedBuf::new();
        let mut renderer = TsvRenderer::with_writers(out.clone(), err.clone());
        let meta = make_meta("anonymous", "https://api.test.dasch.swiss");
    ...
    #[test]
    fn resource_types_tsv_with_builtins() {
        let out = SharedBuf::new();
        let mut renderer = TsvRenderer::with_writer(out.clone());
        let view = ResourceTypeListView {
    ...
    #[test]
    fn resource_types_tsv_with_filter() {
        // filter does not affect the TSV output shape; just verify it renders cleanly
        let out = SharedBuf::new();
        let mut renderer = TsvRenderer::with_writer(out.clone());
        let view = ResourceTypeListView {
    ...
    #[test]
    fn resource_types_tsv_stderr_disclosure() {
        let out = SharedBuf::new();
        let err = SharedBuf::new();
        let mut renderer = TsvRenderer::with_writers(out.clone(), err.clone());
        let view = ResourceTypeListView {
    ...
    #[test]
    fn resource_types_tsv_with_count_auto_shows_column() {
    ...
    #[test]
    fn resource_type_describe_tsv_with_count_no_column_but_disclosure_carries_caveat() {
    ...
    #[test]
    fn resource_describe_tsv_some_values_no_note_renders_value_rows() {
        ...
        assert!(
            ...
            "tsv values header must be the compact default set; got:\n{stdout}"
        );
        assert!(
    ...
    #[test]
    fn resource_describe_tsv_no_values_no_note() {
