...
mod header;
mod hero;
use footer::tailwind_footer;
use header::tailwind_header;
use hero::tailwind_hero;
...
pub fn tailwind_experiment() -> Markup {
    let nav_elements = vec![
        NavElement::Item(NavItem { label: "Projects", href: "#" }),
        NavElement::Item(NavItem { label: "Services", href: "#" }),
        ...
        NavElement::Item(NavItem { label: "About us", href: "#" }),
        NavElement::Item(NavItem { label: "Plattform", href: "#" }),
        NavElement::Item(NavItem { label: "FAQ", href: "#" }),
    ];
    ...
    let footer_config = FooterConfig {
        ...
        copyright_text: "© 2024 Your Company, Inc. All rights reserved.",
        logo_light_url: "https://tailwindcss.com/plus-assets/img/logos/mark.svg?color=indigo&shade=600",
        logo_dark_url: "https://tailwindcss.com/plus-assets/img/logos/mark.svg?color=indigo&shade=500",
    };
    ...
    html! {
        ...
        div class="bg-white dark:bg-gray-900" {
            (tailwind_header(nav_elements, &header_config))
            main {
                (tailwind_hero(&hero_config))
                // Future sections will go here
            }
            (tailwind_footer(&footer_config))
        }
    }
}
