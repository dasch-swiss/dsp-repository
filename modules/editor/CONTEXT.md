...
- **"Collect"** is the telemetry endpoint (`/telemetry/collect`) and the unbuilt approved-record collection. Resolution: "collect a beacon" vs "collect an approved record"; never bare.
