...
// Generated by macro
use crate::{AccordionRoute, BadgeRoute, BreadcrumbRoute, ButtonGroupRoute, ButtonRoute, CardRoute, IconRoute, TabsRoute};
                    ...
                    <nav class="bg-white border-b border-gray-200">
                        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            <div class="flex gap-8 h-16 items-center">
                                ...
                                <A href="/breadcrumb" attr:class="text-gray-700 hover:text-gray-900">
                                    "Breadcrumb"
                                </A>
