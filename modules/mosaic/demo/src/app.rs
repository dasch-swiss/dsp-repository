...
use mosaic_tiles::sidebar::{Sidebar, SidebarContent, SidebarGroup, SidebarHeader};
...
fn AppContent() -> impl IntoView {
    ...
    view! {
        <div class="min-h-screen bg-gray-50 flex flex-col">
            // Top bar with logo (left padding for sidebar trigger)
            <div class="bg-white border-b border-gray-200 sticky top-0 z-40">
                <div class="flex items-center h-16 px-4 sm:px-6 lg:px-8 pl-16">
            ...
            <div class="flex flex-1 overflow-hidden">
                // Sidebar navigation (island manages its own state, includes toggle button)
                <Sidebar>
