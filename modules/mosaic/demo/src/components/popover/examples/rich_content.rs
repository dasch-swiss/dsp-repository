                ...
                <div class="p-4 space-y-3">
                    ...
                    <div class="border-t border-gray-200 pt-3">
                        ...
                        <div class="flex items-center gap-3">
                            <Button variant=ButtonVariant::Outline on:click=decrement>
                                "-"
                            </Button>
                            <span class="text-lg font-semibold min-w-[3ch] text-center">
                                {count}
                            </span>
                            <Button variant=ButtonVariant::Outline on:click=increment>
                                "+"
                            </Button>
                        </div>
                    </div>
